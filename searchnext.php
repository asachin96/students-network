...
<?php 
	...
	$prev=$off-10;
	$next=$off+10;
	if($_GET['dir']=='next'){$off=$off+10;}
	else if($_GET['dir']=='prev'){$off=$off-10;}
	echo"<div class='ask_doubt_wrap'><div id='ask_doubt' align='center'>$cat($count)</div></div>";
	switch($cat){
	...
	if($loaded>10)
		echo "<div class='people_link1'><a href='searchnext.php?cat=$cat&loaded=$prev&dir=prev&search=$search&count=$count'  class='people_a'>prev</a></div>";
	else
		echo "<div class='people_link1'><a href='searchmore.php?cat=$cat&search=$search&count=$count'  class='people_a'>prev</a></div>";
	if($off<=$count+1){
	echo "<div class='people_link'><a href='searchnext.php?cat=$cat&loaded=$next&dir=next&search=$search&count=$count' class='people_a'>next</a></div>";}
	break;
